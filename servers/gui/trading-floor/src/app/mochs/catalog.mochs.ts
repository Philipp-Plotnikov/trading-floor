...
export namespace CatalogMochs {
	export const GOODS: Record<string, ICatalog.CatalogData[]> = {
        ...
        `,
			...
			},
			{
				...
				description: `
				  ...
				  with Alexa Built-in (UN50AU8000FXZA, 2021 Model)
        `,
				price: 19000,
				mark: 4,
			},
        ...
        `,
          ...
          with Rocket Pillow and Fleece Throw Blanket
        `,
				price: 1900,
				mark: 5,
			},
		...
		oculus: [
			...
			},
			{
				...
				description: `
				  ...
				  Headset w/ Fit Pack Bundle, High Resolution, PC VR Compatible,
				  W/GM Controller Protection Controller Grip Accessories
				`,
				price: 31400,
				mark: 5,
			},
